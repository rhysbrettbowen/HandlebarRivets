...
(function() {
  ...
  Rivets.Binding = (function() {
    ...
    Binding.prototype.set = function(value) {
      ...
      deps = (_ref = this.options.dependencies) != null ? _ref.map(function(d) {
        var path;

        path = d.split('.').reverse();
        return Rivets.config.adapter.read(_this.options.models[path.pop()], path.join('.'));
      }) : void 0;
      value = value instanceof Function && !this.binder["function"] ? this.formattedValue(value.apply(this.model, deps || [])) : this.formattedValue(value);
      ...
      routine: function(el, collection) {
        ...
        if (collection) {
          ...
          for (_k = 0, _len2 = collection.length; _k < _len2; _k++) {
            ...
            this.options.models['this'] = data['this'];
            view = new Rivets.View(itemEl, data, this.options);
            view.bind();
